    ...
    async render(id) {
        ...
        return /* html */`
            ...
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                ...
                <a href="/admin/products/" class="text-indigo-600 hover:text-indigo-900 block">List Product</a>
            </div>
            </header>
                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <div class="grid grid-cols-12 gap-6">
                                        ...
                                        <div class="col-span-12">
                                            ...
                                            <input type="text" name="name" id="name-product" autocomplete="name" value="${data.name}"
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        </div>
                                        <div class="col-span-12">
                                        ...
                                        <div class="col-span-12">
                                            ...
                                            <input type="text" name="price" id="price-product" autocomplete="price" value="${data.price}"
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        </div>
                                        <div class="col-span-12">
                                            <label for="detail" class="block text-sm font-medium text-gray-700">Detail</label>
                                            <input type="text" name="detail" id="detail-product" autocomplete="detail" value="${data.detail}"
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        </div>
                                        ...
                                        <div class="col-span-12">
                                            ...
                                            <img src="${data.image}" class="max-h-[140px]">
                                        </div>
                                        <div class="col-span-12">
